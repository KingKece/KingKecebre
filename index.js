...
🌷 KALAU MAU RENAME TARO CREDITS GUA : YsMods Wa☆ */
...
if (anu.action == 'add') {
haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `𝙷𝚊𝚒 @${num.split("@")[0]} 𝚂𝚎𝚕𝚊𝚖𝚊𝚝 𝙳𝚊𝚝𝚊𝚗𝚐 𝙳𝚒 𝙶𝚛𝚘𝚞𝚙 ${metadata.subject}

𝚂𝚒𝚕𝚊𝚑𝚔𝚊𝚗 𝙳𝚒 𝚒𝚜𝚒 𝚔𝚊𝚛𝚝𝚞 𝚒𝚗𝚝𝚛𝚘𝚗𝚢𝚊
...
║ *𖤐 𝙷𝚘𝚋𝚒*       ➥
║ *☻ 𝚜𝚝𝚊𝚝𝚞𝚜*    ➥
║ *ဗီူဗီူ 𝙰𝙻𝙰𝚂𝙰𝙽 𝙼𝚂𝙺 𝙶𝚁𝙿* ➥
╠══════════════╗
║  *✧ sᴇᴍᴏɢᴀ ʙᴇᴛᴀʜ ᴅɪ sɪɴɪ ʏʜ ✧*
║  ✧ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ sᴠ ᴀᴅᴍɪɴ✧
╚═════ꪶ ཻུ۪۪ꦽꦼ̷⸙  ━ ━ ꪶ ཻུ۪۪ꦽꦼ̷═╝
`})
} else if (anu.action == 'remove') {
haikal.sendMessage(anu.id, { image: { url: ppuser }, mentions: [num], caption: `⚠️ᴘᴇɴɢᴜᴍᴜᴍᴀɴ⚠️
@${num.split("@")[0]} ᴛᴇʟᴀʜ ᴅɪ ᴛᴇʟᴀɴ ʙᴜᴍɪ
ᴇʜ ᴍᴀᴋsᴜᴅɴʏᴀ ᴛᴇʟᴀʜ ᴋᴇʟᴜᴀʀ ɢʀᴏᴜᴘ
✎﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏
sʟᴀᴍᴀᴛ ᴛɪɴɢɢᴀʟ ᴀsᴜ 😇
`})
...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await haikal.getName(i + '@s.whatsapp.net')}\nFN:${await haikal.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:DEVELOPER YsMods Wa => Owner : 082217841377\nX-WA-BIZ-NAME:YsMods BOT\nEND:VCARD`})}
//=================================================//
...
connectToWhatsApp();
  ...
  haikal.sendMessage('6282217841377' + "@s.whatsapp.net", { text: `⚠️ʟᴀᴘᴏʀ ʙᴀɴɢ⚠️
sᴀʏᴀ ɪᴢɪɴ ᴘᴀᴋᴇ ʙᴏᴛ ɴʏᴀ 
...
ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ https://Wa.me/6281927450498` });
}
